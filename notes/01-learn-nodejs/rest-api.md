...
const server = http.createServer(async (req, res) => {
  ...
  // returns the query params as an object {country: "", continent: ""}
...
*/
  ...
  // don't want to use startsWith method since every request path starts with api, the
  // other endpoints would then not be hit
